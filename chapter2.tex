...
For simplicity, in our thesis a task is defined as a register initialized with state $0$.
Each task has a unique identifier from the
set $\mathcal{L} = [m] = \{l_0, l_1, l_2,..., l_m\}$, where 
