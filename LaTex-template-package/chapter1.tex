...
We could notice that each DoTask or InsertTask operation can be associated with a unique index of the task array at the leaf corresponding to the task it removed or inserted.


To identify the linearization point for each operation, we firstly need to define the concept that a DoTask or InsertTask operation is counted at a node.
